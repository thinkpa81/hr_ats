...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <title>JSH ATS - 지능형 채용관리 시스템</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <span class="text-xl font-bold">JSH ATS</span>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <form id="email-send-form" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="email-subject" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="[JSH] 이메일 제목">
                        </div>
                        <div>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (emailTypeSelect) {
                    emailTypeSelect.addEventListener('change', (e) => {
                        const templates = {
                            'application_received': {
                                subject: '[JSH] 지원서 접수 완료',
                                body: '안녕하세요 [이름]님,\\n\\n지원서가 정상적으로 접수되었습니다.\\n서류 전형 결과는 일주일 내 안내드리겠습니다.\\n\\n감사합니다.\\nJSH 인사팀'
                            },
                            'interview_scheduled': {
                                subject: '[JSH] 면접 일정 안내',
                                body: '안녕하세요 [이름]님,\\n\\n서류 전형 합격을 축하드립니다!\\n\\n면접 일정: [날짜] [시간]\\n면접 장소: [장소]\\n\\n준비물: 신분증, 이력서 1부\\n\\n감사합니다.\\nJSH 인사팀'
                            },
                            'offer': {
                                subject: '[JSH] 최종 합격 통보',
                                body: '안녕하세요 [이름]님,\\n\\n최종 합격을 축하드립니다!\\n\\n채용 조건은 별도로 안내드릴 예정이며,\\n입사 의사를 2주 내 회신 부탁드립니다.\\n\\n감사합니다.\\nJSH 인사팀'
                            },
                            'rejection': {
                                subject: '[JSH] 전형 결과 안내',
